/**
 * WHAT: This is a list of all supported currencies.
 * WHY: We need a central list so the user can pick 'from' and 'to' currencies in the dropdowns.
 * HOW: It's an array of objects, where each object has a 'code' (like USD) and a 'label' (full name).
 */
export const currencyList = [
    ...
    { code: "SCR", label: "SCR - Seychelles Rupee" },
